...
arguments using the rest parameter syntax (`...args: any`). */
	...
	_handleRequest() {
		const handleRequest = (req, res) =>
			__awaiter(this, void 0, void 0, function* () {
				this.request = new request_1.default(req);
				this.response = new response_1.default(res);
	...
	process(index) {
		...
		return __awaiter(this, void 0, void 0, function* () {
			...
			const next = () =>
				__awaiter(this, void 0, void 0, function* () {
					return yield this.process(index + 1);
				});
			try {
				const url =
					(_a = this.request.url) === null || _a === void 0 ? void 0 : _a.split("?")[0];
				const method = this.request.method.toLocaleLowerCase();
				const urlSegments =
					url === null || url === void 0 ? void 0 : url.split("/").filter(Boolean);
