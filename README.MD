...
FastNet is a lightweight and easy-to-use Node.js web framework designed to be very minimal With a focus on simplicity , Fasnet api's are same signature of express 
